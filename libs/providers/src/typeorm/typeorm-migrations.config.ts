...
const options = (): DataSourceOptions => {
    ...
    return {
        ...
        migrations: [join(process.cwd(), "migrations", "js", "*migration.{ts, js}")], /* (путь миграций - cwd выдаст путь к корневой папке, в ней папка migrations, все документы, заканчивающиеся на migration.ts) */
